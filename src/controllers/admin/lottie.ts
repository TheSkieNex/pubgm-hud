...
class AdminLottieController {
  @errorHandler()
  static async get(req: AuthorizedRequest, res: Response): Promise<void> {
  ...
  @errorHandler()
  static async getAll(req: AuthorizedRequest, res: Response): Promise<void> {
  ...
  @errorHandler()
  static async upload(req: AuthorizedRequest, res: Response): Promise<void> {
  ...
  @errorHandler()
  static async update(req: AuthorizedRequest, res: Response): Promise<void> {
  ...
  @errorHandler()
  static async delete(req: AuthorizedRequest, res: Response): Promise<void> {
    const { uuid } = req.params;
  ...
  @errorHandler()
  static async toggleLayer(req: AuthorizedRequest, res: Response): Promise<void> {
  ...
  @errorHandler()
  static async layerContent(req: AuthorizedRequest, res: Response): Promise<void> {
    const { uuid, layerIndex } = req.params;
  ...
  @errorHandler()
  static async getLayersData(req: AuthorizedRequest, res: Response): Promise<void> {
    const { uuid } = req.params;
  ...
  @errorHandler()
  static async updateLayer(req: AuthorizedRequest, res: Response): Promise<void> {
...
export default AdminLottieController;
